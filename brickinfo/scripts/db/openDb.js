...
function createDb(event) {
    return __awaiter(this, void 0, void 0, function () {
        var createPromise, createResponse;
            ...
            switch (_a.label) {
                case 0:
                    createPromise = new Promise(function (resolve, reject) {
                        ...
                        var objectStore = db.createObjectStore("Elements", { keyPath: "elementId" });
                        ...
                        objectStore.transaction.oncomplete = function () { resolve(db); };
                    });
...
export function openDb(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var openPromise, openResponse;
        var _this = this;
        var dbName = _b.dbName;
            ...
            switch (_c.label) {
                case 0:
                    openPromise = new Promise(function (resolve, reject) {
                        ...
                        request.onupgradeneeded = function (event) { return __awaiter(_this, void 0, void 0, function () {
                            var db;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        console.log('onUpgradeNeeded');
                                        return [4 /*yield*/, createDb(event)];
                                    case 1:
                                        db = _a.sent();
                                        resolve(db);
                                        return [2 /*return*/];
                ...
                case 1:
                    openResponse = _c.sent();
                    console.log('openResponse: ', openResponse);
                    return [2 /*return*/, openResponse];
            }
        });
    });
}
